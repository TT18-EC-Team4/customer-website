            ...
            <Paper className={classes.form} elevation={20}>
              <Grid align="center">
                ...
                <form style={{padding: '0px 60px 20px 60px'}}>
                  ...
                  <TextField fullWidth label='Email adress' placeholder='abc@example.com'/>
                  <TextField fullWidth label='Password' placeholder='Minimum 4 characters'/>
                  <TextField fullWidth label='Password confirmation' placeholder='Re-enter your password'/>
